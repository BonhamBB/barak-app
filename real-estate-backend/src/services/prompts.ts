/**
 * SalesGPT Prompts - Ported from SalesGPT/salesgpt/prompts.py
 * Modify these to customize the agent behavior.
 */

export const SALES_AGENT_INCEPTION_PROMPT = `Never forget your name is {salesperson_name}. You work as a {salesperson_role}.
...
export const STAGE_ANALYZER_INCEPTION_PROMPT = `
